...
## Setup Instructions
To set up the AI-Based BOM Generator locally, follow these steps:
...
Generating a Basic BOM
    ...
    Navigate to the input form on the web interface.
    Enter the specifications for the components required.
    Click on the "Generate BOM" button.
    View and export the generated BOM.
